...
import { Home, FileText, Settings, Moon, Sun, ChevronDown, Clock, Zap } from "lucide-react";
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const isScriptPage = location.pathname === "/scripts" || location.pathname === "/scripts/short";
            ...
            <nav className="flex items-center gap-2">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <span className="hidden md:inline">台本生成</span>
                ...
                {isScriptDropdownOpen && (
                  <div className="absolute top-full right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
                    <button
                      onClick={() => {
                        navigate("/scripts");
                        setIsScriptDropdownOpen(false);
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium">長尺動画</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">5-10分の詳細な漫談</div>
                      </div>
                    </button>
                    <button
                      onClick={() => {
                      ...
                      className={cn(
                        "w-full flex items-center gap-3 px-4 py-3 text-left transition-colors",
                        location.pathname === "/scripts/short"
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium">ショート動画</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">60秒の高速生成</div>
                      </div>
                    </button>
                  </div>
                )}
