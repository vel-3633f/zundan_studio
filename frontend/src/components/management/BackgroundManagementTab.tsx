...
import { Image, Loader2, RefreshCw, Trash2, CheckSquare, Square } from "lucide-react";
...
export const BackgroundManagementTab = () => {
  ...
  const getImageUrl = (path: string) => {
    ...
    return `${API_BASE_URL}/api/management/backgrounds/file/${filename}`;
  };
      ...
      <div className="space-y-6">
        ...
        {backgrounds.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {backgrounds.map((bg) => {
              const imageUrl = getImageUrl(bg.path);
        ...
        {selectedImage && (
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            {(() => {
              ...
              const imageUrl = getImageUrl(selectedBg.path);
              return (
