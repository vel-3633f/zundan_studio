...
from app.core.section_generators.section_context_builder_legacy import (
    build_context_text,
...
SECTION_OUTLINE_VARIABLES = {
    ...
    "deterioration": ["deterioration_content"],
    "crisis": ["crisis_content"],
    "learning": ["learning_content"],
    "recovery": ["recovery_content"],
}
@dataclass
