...
**このセクションは最終セクションです。**
オチのタイプ「{forced_ending_type}」で面白く終わらせてください。
...
4. **適切な長さ**: 8-15 セリフでしっかりオチをつける
5. **視聴者の反応**: 「え、そうなるの！？」「面白い！」と思わせる

### 実装の流れ

1. **盛り上がり**: 3 人が激しく言い合っている、カオス状態
2. **オチのきっかけ**: `{forced_ending_type}`に基づいた予想外の展開が起こる
3. **キャラクターの反応**: 驚き、困惑、ツッコミなどの反応（3-5 セリフ）
4. **オチの完結**: 面白い結末で締める
5. **ナレーター締め**: ナレーターが淡々と事実を述べて終了

### ナレーターの締め方

- **淡々と**: 感情を込めず、事実だけを述べる
- **短く**: 1-2 文で簡潔に
- **状況説明**: 最終的にどうなったのかを明確に
- **形式**: 「...というわけで、{状況}のまま終了しました」または「...{状況}で終了しました」

**ナレーター例**:

- 「...というわけで、全員が勘違いしたまま終了しました」
- 「...ずんだもんの発言がブーメランとなって終了しました」
- 「...3 人全員が暴走したまま終了しました」
- 「...めたんがブチギレて帰ってしまいました」
- 「...結局誰も話を聞いていませんでした」
