...
OUTLINE_PROMPT_FILE = Path("src/prompts/sections/outline_template.md")
...
def generate_outline(
    ...
    try:
        ...
        logger.debug(f"症状進行: {outline.symptom_progression}")
        logger.debug(f"決定的イベント: {outline.critical_event}")
